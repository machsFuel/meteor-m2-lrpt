...
# Author: machsFuel
# Generated: Wed Sep 20 21:29:15 2017
##################################################
...
class top_block(gr.top_block):
    ...
    def __init__(self, destfile='0'):
        ...
        # Variables
        ##################################################
        self.samp_rate_airspy = samp_rate_airspy = 2500000
        self.decim = decim = 16
        ...
        self.bitstream_name = bitstream_name = "/home/machs/gnuRadioFiles/meteor_LRPT_" + datetime.now().strftime("%d%m%Y_%H%M") + ".s"

        ##################################################
        # Blocks
        ##################################################
        self.rtlsdr_source_0 = osmosdr.source( args="numchan=" + str(1) + " " + 'rtl=067' )
        self.rtlsdr_source_0.set_sample_rate(samp_rate_airspy)
        self.rtlsdr_source_0.set_center_freq(freq, 0)
        self.rtlsdr_source_0.set_freq_corr(1, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, destfile + ".s", False)
    ...
    def set_destfile(self, destfile):
        self.destfile = destfile
        self.blocks_file_sink_0.open(self.destfile + ".s")
...
def argument_parser():
    ...
    parser.add_option(
        "", "--destfile", dest="destfile", type="string", default='0',
        help="Set destfile [default=%default]")
    return parser
...
def main(top_block_cls=top_block, options=None):
    ...
    tb = top_block_cls(destfile=options.destfile)
    tb.start()
    tb.wait()
